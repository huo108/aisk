...
public class AiskApp extends BaseApplication {
    ...
    private void forCookie() {
        HttpDataSourceImpl.getInstance(RetrofitClient.getInstance().create(ApiService.class)).login("username", MD5Util.MD5("password").toUpperCase(),"VERI").compose(RxUtils.schedulersTransformer()) //线程调度
