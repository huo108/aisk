...
import com.mvvm.library.http.ResponseThrowable;
...
public class NetWorkViewModel extends BaseViewModel<AiskRepository> {
    ...
    public NetWorkViewModel(@NonNull Application application, AiskRepository repository) {
    ...
    public ItemBinding<NetWorkItemViewModel> itemBinding = ItemBinding.of(BR.viewModel, R.layout.item_bill);
    //下拉刷新
